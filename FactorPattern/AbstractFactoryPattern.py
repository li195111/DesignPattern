...
class GraphicFactory(Factory):
    ...
    def create(self, dimensions: dict):
        return self.graph_map[self.graph_type](self.graph_type).create(dimensions)
    
if __name__ == "__main__":
    print (GraphicFactory(GraphType.Circle).create({'width':10, 'height':10, 'radius':10}))
    print (GraphicFactory(GraphType.Circle).create({'width':20, 'height':20, 'radius':20}))
    print (GraphicFactory(GraphType.Circle).create({'width':30, 'height':30, 'radius':30}))
    print (GraphicFactory(GraphType.Rectangle).create({'width':10, 'height':10, 'radius':10}))
    print (GraphicFactory(GraphType.Rectangle).create({'width':20, 'height':20, 'radius':20}))
    print (GraphicFactory(GraphType.Rectangle).create({'width':30, 'height':30, 'radius':30}))
    print (GraphicFactory(GraphType.Triangle).create({'width':10, 'height':10, 'radius':10}))
    print (GraphicFactory(GraphType.Triangle).create({'width':20, 'height':20, 'radius':20}))
    print (GraphicFactory(GraphType.Triangle).create({'width':30, 'height':30, 'radius':30}))